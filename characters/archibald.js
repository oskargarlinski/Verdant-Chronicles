const archibald = [
  // Spread 1 — Character card + backstory
  {
    left: `
      ...
      <div class="char-subtitle">Variant Human · Paladin / Fighter</div>
      <div class="char-divider"><hr><span>✦</span><hr></div>
      <div class="stat"><span class="stat-label">Title</span><span class="stat-value">Templar Chaplain of Anelon</span></div>
      <div class="stat"><span class="stat-label">Oath</span><span class="stat-value">Oath of the Crown</span></div>
      <div class="stat"><span class="stat-label">King</span><span class="stat-value">Galan Farric of Anelon</span></div>
      <div class="stat"><span class="stat-label">Background</span><span class="stat-value">Knight of the Order</span></div>
      <div class="stat"><span class="stat-label">Motivation</span><span class="stat-value">Lift the curse on Anelon</span></div>
      <div class="stat"><span class="stat-label">Status</span><span class="stat-value" style="color:#2a6e2a;">Active</span></div>
      <div class="stat"><span class="stat-label">Current Epithet</span><span class="stat-value" style="font-style:italic;color:#8b6a3a;">To be earned in the field…</span></div>
      <div class="handnote" style="margin-top:16px;">"Not the closest advisor.<br>Just the honest one."</div>`,
    right: `
